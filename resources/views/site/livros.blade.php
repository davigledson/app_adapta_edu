...
<main class="col-100 indicacoes">
    <div class="content livro">
        <div class="col-4 p-4 superior2">
            <h3 style="margin:1rem;"><strong>Enfrentando o TOD: 40 questões para lidar com o transtorno opositivo desafiador</strong></h3>
        ...
        <div class="col-4 superior2">
            <h3 style="margin:1rem;"><strong>Manual dos transtornos escolares</strong></h3>
        ...
        <div class="col-4 superior2">
            <h3 style="margin:1rem;"><strong>CRIANÇAS DESAFIADORAS</strong></h3>
        ...
        <div class="col-4 inferior2">
            <h3 style="margin:1rem;"><strong>Como enfrentar o Transtorno Opositivo Desafiador na escola</strong></h3>
        ...
        <div class="col-4 inferior2">
            <h3 style="margin:1rem;"><strong>Técnicas e recursos terapêuticos: 100 ideias para estimular diálogos com crianças e adolescentes</strong></h3>
     ...
     <div class="col-4  superior2">
            <h3 style="margin:1rem;"><strong>{{$livro->titulo}}</strong></h3>
            <img src="{{asset('storage/'.$livro->arquivo)}}">
            <a href="{{$livro->link}}" target="_blank"><button>Compre aqui!</button></a>
